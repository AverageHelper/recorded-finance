...
## [Unreleased]
### Changed
- Now using Vite for build, to avoid import overhead on back-end. Also lets us use module aliases properly.
...
[Unreleased]: https://github.com/RecordedFinance/recorded-finance/compare/v0.18.4...HEAD
